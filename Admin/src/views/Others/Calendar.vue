...
import { getLocalDateString, getLocalTime } from "@/utils/dateUtils";
...
onMounted(() => {
  events.value = [
    ...
    },
    {
      id: "2",
      title: "Meeting",
      start: new Date(getLocalTime() + 86400000).toISOString().split("T")[0],
      extendedProps: { calendar: "Success" },
    },
    {
      id: "3",
      title: "Workshop",
      start: new Date(getLocalTime() + 172800000).toISOString().split("T")[0],
      end: new Date(getLocalTime() + 259200000).toISOString().split("T")[0],
