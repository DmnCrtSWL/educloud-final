        ...
        <div class="flex items-center gap-2 2xsm:gap-3">
          ...
          >
            ...
            <select
              ...
              class="block w-full min-w-[280px] rounded-lg border-0 py-2.5 pl-11 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-brand-600 text-base font-medium dark:bg-gray-800 dark:text-white dark:ring-gray-700 bg-transparent cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
            >
              ...
              <option
                ...
                :value="group.id"
              >
                {{ group.grado }}ro {{ group.grupo }} - {{ group.materia }}
              </option>
            </select>
          </div>
          <ThemeToggler />
...
const { assignedGroups, selectedGroupId } = useGroupState();
